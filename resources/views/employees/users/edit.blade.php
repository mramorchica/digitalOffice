      ...
      <form method="post" action='{{url("users/$user->id")}}' class="form-horizontal">
        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" name="name" min="8" class="form-control" id="name" value="{{old('name', $user->name)}}" placeholder="Name" required>
            </div>
          </div>
          <div class="form-group row">
            <label for="email" class="col-sm-2 col-form-label">Email</label>
            <div class="col-sm-10">
              <input type="email" name="email" class="form-control" id="name" value="{{old('email', $user->email)}}" placeholder="Email" required>
            </div>
          </div>
          <div class="form-group row">
            <label for="phone" class="col-sm-2 col-form-label">Phone</label>
            <div class="col-sm-10">
              <input type="text" name="phone" class="form-control" id="phone" value="{{old('phone', $user->phone)}}" placeholder="Phone" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-1">
              <input type="number" name="level" min="1" max="10" class="form-control" id="level" value="{{old('level', $user->level)}}" placeholder="Level">
            </div>
          </div>
