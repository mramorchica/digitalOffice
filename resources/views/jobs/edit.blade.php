      ...
      <form method="post" action='{{url("jobs/$job->id")}}' class="form-horizontal">
        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" name="title" class="form-control" id="title" value="{{old('title', $job->title)}}" placeholder="Title" required>
            </div>
          </div>
          <div class="form-group row">
            <label for="location" class="col-sm-2 col-form-label">Location</label>
            <div class="col-sm-10">
              <input type="text" name="location" class="form-control" id="location" value="{{old('location', $job->location)}}" placeholder="Location" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <textarea name="description" id="description">{!! old('description', $job->description) !!}</textarea>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <textarea name="responsibilities" id="responsibilities">{!! old('responsibilities', $job->responsibilities) !!}</textarea>
            </div>
          </div>
          <div class="form-group row">
            <label for="our_offer" class="col-sm-2 col-form-label">Our offer</label>
            <div class="col-sm-10">
              <textarea name="our_offer" id="our_offer">{!! old('our_offer', $job->our_offer) !!}</textarea>
            </div>
          </div>
            ...
            <div class="col-sm-10">
              <select name="position_id" id="position_id" class="form-control">
                ...
                @foreach($positions as $position)
                  <option value="{{$position->id}}" {{ old('position_id', $job->position_id) == $position->id ? 'selected' : '' }}>{{$position->name}}</option>
                @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-1">
              <input type="text" name="how_to_apply" class="form-control" id="how_to_apply" value="{{old('how_to_apply', $job->how_to_apply)}}" placeholder="How to apply">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-1">
              <input type="date" name="start_date" class="form-control" id="start_date" value="{{old('start_date', $job->start_date)}}" placeholder="Start Date">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-1">
              <input type="date" name="end_date" class="form-control" id="end_date" value="{{old('end_date', $job->end_date)}}" placeholder="End Date">
            </div>
          </div>
